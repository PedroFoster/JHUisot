...
int main ()
{
	...
	//Structure variables	
	char fx[] = "./get/data/vx+vy_long_isot_t60_N1024_full.txt";
//	char fy[] = "./get/data/vy_isot_t60_N1024_completing.txt";
	char ftreatedx[] = "./out_statistic/treated_data/vx+vy_long_isot_t60_N1024_full.txt";
	char ftreatedy[] = "./out_statistic/treated_data/vy_long_isot_t60_N1024_full.txt";
